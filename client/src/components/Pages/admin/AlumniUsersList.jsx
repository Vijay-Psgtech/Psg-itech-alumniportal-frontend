        ...
        <AnimatePresence>
          {selectedItem && (
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="fixed inset-0 bg-slate-900/60 flex items-center justify-center z-[1000] p-4 backdrop-blur-sm"
                ...
                {selectedItem.firstName ? (
                  <>
                    ...
                    <div className="flex items-center gap-4 mb-7 pb-5 border-b border-slate-100">
                      <div className="w-16 h-16 rounded-full overflow-hidden bg-gradient-to-br from-orange-500 to-orange-600 flex items-center justify-center text-white font-bold text-lg">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      {[
                        ...
                        >
                          ...
                          <p className="text-[14px] font-semibold text-slate-900 mt-1 break-words">
                            {it.v}
                          </p>
                        </div>
                      ))}
