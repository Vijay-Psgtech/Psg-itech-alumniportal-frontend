...
// Banner API — clean method names used by Hero.jsx and admin banner UI.
// (bannerService above stays as-is for backward compatibility with anything
// already calling getActiveBanner/getAllBanners/etc directly.)
export const bannerAPI = {
  getActive: () => bannerService.getActiveBanner(),
  getAll: () => bannerService.getAllBanners(),
  create: (data) => bannerService.createBanner(data),
  update: (data) => bannerService.updateBanner(data),
  delete: (id) => bannerService.deleteBanner(id),
  setActive: (id) => bannerService.setActiveBanner(id),
};
