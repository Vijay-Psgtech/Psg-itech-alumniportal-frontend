  ...
  return (
    <div className="relative">
      ...
      <div className="flex flex-wrap items-center gap-2 mb-4.5">
        <span className="text-[10px] text-gray-400 font-bold tracking-[1.5px] mr-1">
          YEAR:
        </span>
        {years.map((y) => {
          ...
          return (
            <button
              ...
              className={`px-4 py-1.5 rounded-xl border-2 font-display text-[15px] font-bold transition-all shadow-sm ${isSel ? "shadow-md scale-105" : "bg-white border-transparent text-gray-500 hover:border-slate-200"}`}
              style={
                isSel
                  ? {
        ...
        {showAddYear ? (
          <div className="flex gap-1.5 bg-white p-1 rounded-2xl border border-slate-200 shadow-sm ml-1">
            <input
              ...
              placeholder="YYYY"
              maxLength={4}
              className="px-3 py-1 bg-transparent w-20 text-[13px] outline-none font-medium"
          ...
          <button
            ...
            className="px-3.5 py-1.5 rounded-xl border-2 border-dashed border-slate-300 bg-slate-50/50 text-gray-400 text-xs font-bold cursor-pointer flex items-center gap-1.5 hover:border-slate-400 hover:text-gray-600 transition-all hover:bg-slate-50 ml-1"
          >
      ...
      >
        <div className="text-center sm:text-left">
          ...
          <div className="text-sm font-medium text-gray-500 mt-1 flex items-center justify-center sm:justify-start gap-2">
        ...
        <div className="flex gap-3 items-center w-full sm:w-auto">
          ...
          <button
            ...
            className="px-4.5 py-2.5 rounded-xl border-none bg-gradient-to-br from-orange-500 to-orange-900 text-white text-[13px] font-bold cursor-pointer flex items-center gap-1.5 whitespace-nowrap shadow-lg shadow-orange-600/30 transition-all hover:-translate-y-0.5 hover:shadow-orange-600/50 active:translate-y-0"
          >
