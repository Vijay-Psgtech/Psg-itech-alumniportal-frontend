        ...
        <div className="p-8">
            ...
            {step === STEPS.EMAIL && (
              <>
                ...
                <form onSubmit={handleSendOtp}>
                  ...
                  <button type="submit" className="w-full py-3 rounded-lg bg-gradient-to-r from-orange-400 to-orange-400 text-slate-900 font-semibold hover:shadow-md disabled:opacity-60" disabled={loading}>
            ...
            {step === STEPS.OTP && (
              <>
                ...
                <form onSubmit={handleVerifyOtp}>
                  ...
                  <button type="submit" className="w-full py-3 rounded-lg bg-gradient-to-r from-orange-400 to-orange-400 text-slate-900 font-semibold hover:shadow-md disabled:opacity-60" disabled={loading || otp.length < 4}>
            ...
            {step === STEPS.RESET && (
              <>
                ...
                <form onSubmit={handleResetPassword}>
                  ...
                  <button
                    type="submit" className="w-full py-3 rounded-lg bg-gradient-to-r from-orange-400 to-orange-400 text-slate-900 font-semibold hover:shadow-md disabled:opacity-60"
            ...
            {step === STEPS.DONE && (
              <div className="text-center py-4">
                ...
                <button className="w-full py-3 rounded-lg bg-gradient-to-r from-orange-400 to-orange-400 text-slate-900 font-semibold" onClick={() => navigate("/alumni/login")}>
                  Go to Login →
                </button>
              </div>
            )}
