            ...
            <div className="flex items-start justify-between gap-3">
              ...
              {onMessage && user && String(user?._id || user?.id) !== String(typeof chapter?.foundedBy === "object" ? chapter?.foundedBy?._id : chapter?.foundedBy || "") && (
                <button
                  ...
                  className="inline-flex items-center gap-2 rounded-lg border border-orange-200 bg-white px-3 py-2 text-sm font-semibold text-orange-700 transition hover:bg-orange-50"
                >
