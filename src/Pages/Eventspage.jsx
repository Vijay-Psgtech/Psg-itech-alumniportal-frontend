            ...
            >
              {filtered.map((event) => (
                <motion.div key={event._id} variants={fadeUp}>
                  ...
                  >
                    <div className="w-full sm:w-56 h-40 sm:h-36 shrink-0 rounded-xl overflow-hidden bg-linear-to-br from-slate-900 to-slate-700 grid place-items-center text-orange-400/80 relative">
                      <img
