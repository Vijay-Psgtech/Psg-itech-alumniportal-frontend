...
const AlumniUsersList = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-linear-to-br from-slate-100 via-white to-orange-50 mt-16 p-4 sm:p-6 lg:p-24 flex items-center justify-center">
              ...
              {alumniUsers.map((alumni, idx) => (
                ...
                >
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      className="flex-1 px-4 py-2 border border-gray-300 text-gray-700 rounded-lg text-sm font-medium hover:bg-slate-50 transition-colors"
                          ...
                          <div className="flex items-center gap-3">
                            <div className="w-10 h-10 rounded-full overflow-hidden bg-gray-200 shrink-0">
                              {alumni.profileImage ? (
                                ...
                                <div className="w-full h-full bg-linear-to-br from-orange-400 to-orange-500 flex items-center justify-center text-white font-bold text-sm">
                                  {alumni.firstName.charAt(0)}
                                  {alumni.lastName && alumni.lastName.charAt(0)}
                                </div>
                              )}
