      ...
      <div className="mb-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
          ...
          <button
            ...
            className="px-6 py-3 rounded-xl border-none bg-linear-to-br from-[#f97316] to-[#ea580c] text-white font-bold text-sm cursor-pointer flex items-center justify-center gap-2 shadow-lg shadow-orange-500/25 transition-all hover:-translate-y-0.5 hover:shadow-orange-500/40 active:translate-y-0 w-full sm:w-auto"
          >
          ...
          <div className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center justify-between">
            ...
            <div className="flex items-center gap-3 flex-wrap sm:flex-nowrap justify-between sm:justify-end">
              <div className="text-xs text-gray-500 font-medium whitespace-nowrap">
                ...
                of <strong className="text-slate-900">{sorted.length}</strong>
              </div>
              ...
              {paginatedData.map((event, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-4 pb-4 border-b border-slate-100">
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <h3 className="text-lg font-bold text-slate-900 font-display line-clamp-2">
                            {event.title}
                          </h3>
                        </div>
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                          <span
                            className="inline-block rounded-full px-3 py-1 text-[10px] font-bold tracking-wider border"
                            style={{
                              background: `${cc}15`,
                              color: cc,
                              borderColor: `${cc}30`,
                    ...
                    {/* Description */}
                    {event.description && (
                      <p className="text-xs text-gray-600 line-clamp-2 mb-4 p-3 bg-slate-50 rounded-lg border border-slate-100">
                        {event.description}
                      </p>
                    )}
                    ...
                    <div className="flex gap-2 pt-3 border-t border-slate-100">
                      ...
                      <button
                        ...
                        disabled={isLoading}
                        className="flex-1 px-4 py-2.5 border border-red-200 hover:bg-red-50 rounded-lg bg-white text-red-600 text-sm font-bold flex items-center justify-center gap-2 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                      >
            ...
            {totalPages > 1 && (
              <div className="flex items-center justify-center gap-2 mt-6 flex-wrap">
                <button
                  ...
                  className="px-3 py-2 rounded-lg border border-slate-200 text-sm font-bold disabled:opacity-50 disabled:cursor-not-allowed hover:bg-slate-50"
                >
                  Previous
                </button>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm shadow-black/5">
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead>
                    <tr className="bg-linear-to-r from-slate-50 to-orange-50 border-b border-slate-200">
                          ...
                          <td className="px-6 py-4">
                            <div className="flex items-center gap-3">
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <div className="flex-1">
                                  <p className="text-sm font-bold text-slate-900 font-display line-clamp-2">
                                    {event.title}
                                  </p>
                                </div>
                              </div>
