import React, { useState, useEffect, useCallback, useMemo } from "react";
  ...
  const AdminDashboard = () => {
    ...
    return (
      <div className="bg-slate-100 min-h-screen pt-26 pb-16 px-4 sm:px-6 relative overflow-x-hidden ">
        ...
        <div className="max-w-[1400px] mx-auto relative">
          ...
          >
            ...
            <div className="inline-flex items-center gap-4">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.96 }}
                className="flex items-center gap-2 px-5 py-2.5 bg-red-50 text-red-700 border-none rounded-xl text-[13px] font-bold cursor-pointer uppercase tracking-wider hover:bg-red-100 transition-colors shadow-sm"
              >
          ...
          <AnimatePresence>
            {error && (
              <motion.div
                className="px-4 py-3 rounded-xl mb-5 text-sm flex items-center gap-2.5 font-medium bg-red-50 border border-red-200 text-red-800 shadow-sm"
