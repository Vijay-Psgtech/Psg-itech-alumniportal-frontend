    ...
    >
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-4 flex gap-2.5 items-center shadow-sm transition-shadow focus-within:shadow-md focus-within:border-emerald-200 mb-2">
        ...
        <input
          ...
          className="flex-1 border-none py-1 text-[15px] outline-none text-gray-700 bg-transparent placeholder-gray-400"
        />
        {searchTerm && (
          <button
      ...
      {filtered.length > 0 ? (
          ...
          {filtered.map((d, i) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                {/* Donor Name */}
                <div className="font-bold text-[16px] text-slate-900 leading-tight mb-0.5 flex items-center gap-2">
        ...
        <div className="text-center py-20 px-4 text-gray-400 bg-white border border-slate-200 rounded-2xl shadow-sm flex flex-col items-center">
