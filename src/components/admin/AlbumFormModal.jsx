        ...
        <div className="flex gap-3 mt-6 pt-5 border-t border-slate-100">
          <button
            ...
            className={`flex-1 py-3 rounded-xl border-none text-sm font-bold flex items-center justify-center gap-2 transition-all
                            ${valid && !isLoading ? "bg-linear-to-br from-orange-600 to-orange-900 text-white cursor-pointer shadow-lg shadow-orange-600/25 hover:shadow-orange-600/40 hover:-translate-y-0.5" : "bg-slate-200 text-slate-400 cursor-not-allowed"}
