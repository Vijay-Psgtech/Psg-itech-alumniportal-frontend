    ...
    <div className="relative">
      ...
      <div className="flex flex-wrap items-center gap-2.5 mb-4 border-b border-transparent pb-1">
        ...
        <button
          ...
          className="px-4 py-2.5 rounded-xl border-none bg-gradient-to-br from-[#f97316] to-[#ea580c] text-white text-[13px] font-bold cursor-pointer flex items-center gap-1.5 whitespace-nowrap shadow-md shadow-orange-500/25 transition-all hover:-translate-y-0.5 hover:shadow-orange-500/40"
        >
        ...
        <div className="hidden sm:grid grid-cols-[2.4fr_1fr_1fr_1fr_0.6fr_90px] px-4 py-3 bg-slate-50 border-b border-slate-200">
          {["Title", "Category", "Date", "Status", "Attend.", "Actions"].map(
            (h) => (
              <span
                key={h}
                className="text-[12px] font-bold text-gray-700 tracking-wide uppercase"
              >
                {h}
              </span>
            ),
            ...
            return (
              ...
              >
                <div>
                  ...
                  <span className="text-[12px] text-gray-500 block line-clamp-1">
                    {ev.venue?.split(",")[0]}
                  </span>
                </div>
                ...
                <div className="hidden sm:block">
                  <span
                    className="inline-block rounded-full px-2.5 py-1 text-[13px] font-bold tracking-wide"
                    style={{
                      background: `${cc}15`,
                      color: cc,
        ...
        {totalPages > 1 && (
          <div className="flex justify-end items-center gap-2 px-4 py-3 bg-slate-50 border-t border-slate-200">
            <button
              ...
              className={`px-3 py-1 rounded-md border border-slate-300 bg-white text-sm ${currentPage === 1 ? "cursor-not-allowed opacity-50" : "hover:bg-slate-100"}`}
            >
              Previous
            </button>
            ...
            <button
              ...
              className={`px-3 py-1 rounded-md border border-slate-300 bg-white text-sm ${currentPage === totalPages ? "cursor-not-allowed opacity-50" : "hover:bg-slate-100"}`}
            >
              Next
            </button>
          </div>
